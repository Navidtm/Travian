...
/**
 * SOURCE OF TRUTH ---------------------------------------------------------------------------
 * Stats, categories, and training costs below were extracted directly from a real Travian game
 * server engine (TravianZ-derived), specifically `Data/unitdata.php` (base stats + costs) and
 * `Battle.php` (unit category groupings: `$unitsbytype`).
 *
 * Tribe IDs correspond to the engine's numeric tribe slots: Romans=1, Teutons=2, Gauls=3, Huns=6,
 * Egyptians=7, Spartans=8, Vikings=9 (slots 4/5 are Nature/Natars — non-playable — and are not
 * modeled here).
 */
...
export const UNITS: UnitDefinition[] = [
	...
	},
	{
		...
		capacity: 70,
		populationCost: 4,
		cost: { wood: 660, clay: 750, iron: 800, crop: 180 },
		trainingTimeSeconds: 3520,
	},
	{
		id: 'hun_ram',
		...
		capacity: 0,
		populationCost: 3,
		cost: { wood: 1060, clay: 330, iron: 360, crop: 70 },
		trainingTimeSeconds: 4400,
	},
	{
		id: 'hun_catapult',
		tribe: 'huns',
		...
		capacity: 0,
		populationCost: 6,
		cost: { wood: 950, clay: 1280, iron: 620, crop: 60 },
		trainingTimeSeconds: 9000,
	},
	{
		id: 'tribal_chief',
		...
		capacity: 0,
		populationCost: 5,
		cost: { wood: 37200, clay: 27600, iron: 25200, crop: 27600 },
		trainingTimeSeconds: 90700,
	},
	{
		id: 'hun_settler',
	...
	// ------------------------------------------------------------- EGYPTIANS
	{
		...
		capacity: 20,
		populationCost: 1,
		cost: { wood: 45, clay: 60, iron: 30, crop: 30 },
		trainingTimeSeconds: 640,
	},
	{
		id: 'egyptian_fighter',
		tribe: 'egyptians',
		name: 'Egyptian Fighter',
		category: 'infantry',
		role: 'defense',
		attack: 30,
		defenseInfantry: 55,
	...
	},
	{
		...
		capacity: 3000,
		populationCost: 1,
		cost: { wood: 5040, clay: 6510, iron: 4830, crop: 4620 },
		trainingTimeSeconds: 24800,
	},
	...
	// -------------------------------------------------------------- SPARTANS
	{
		...
		capacity: 60,
		populationCost: 1,
		cost: { wood: 110, clay: 185, iron: 110, crop: 35 },
		trainingTimeSeconds: 1700,
	},
	{
		id: 'agoge_warrior',
		tribe: 'spartans',
		...
		capacity: 40,
		populationCost: 1,
		cost: { wood: 145, clay: 95, iron: 245, crop: 45 },
		trainingTimeSeconds: 1950,
	},
	{
		id: 'homoioi',
		tribe: 'spartans',
		...
		capacity: 50,
		populationCost: 1,
		cost: { wood: 130, clay: 200, iron: 400, crop: 65 },
		trainingTimeSeconds: 2200,
	},
	{
		id: 'perioikoi_scout',
		tribe: 'spartans',
		name: 'Perioikoi Scout',
		category: 'infantry',
		role: 'scout',
		attack: 0,
		defenseInfantry: 25,
		...
		capacity: 0,
		populationCost: 2,
		cost: { wood: 185, clay: 150, iron: 35, crop: 75 },
		trainingTimeSeconds: 1360,
	},
	{
		id: 'spartan_rider',
		...
		capacity: 110,
		populationCost: 2,
		cost: { wood: 555, clay: 445, iron: 330, crop: 110 },
		trainingTimeSeconds: 2600,
	},
	{
		id: 'hippeis',
		tribe: 'spartans',
		...
		capacity: 80,
		populationCost: 3,
		cost: { wood: 660, clay: 495, iron: 995, crop: 165 },
		trainingTimeSeconds: 3450,
	},
	{
		id: 'spartan_ram',
		tribe: 'spartans',
		...
		capacity: 0,
		populationCost: 3,
		cost: { wood: 980, clay: 545, iron: 390, crop: 80 },
		trainingTimeSeconds: 4600,
	},
	{
		id: 'spartan_catapult',
		...
		capacity: 0,
		populationCost: 6,
		cost: { wood: 1200, clay: 1240, iron: 610, crop: 80 },
		trainingTimeSeconds: 9000,
	},
	{
		id: 'ephor',
		...
		capacity: 0,
		populationCost: 4,
		cost: { wood: 33450, clay: 30665, iron: 36240, crop: 27375 },
		trainingTimeSeconds: 90700,
	},
	{
		id: 'spartan_settler',
		tribe: 'spartans',
		name: 'Spartan Settler',
		category: 'infantry',
		role: 'settler',
		attack: 10,
		defenseInfantry: 80,
		...
		capacity: 3000,
		populationCost: 1,
		cost: { wood: 5115, clay: 5580, iron: 6360, crop: 4485 },
		trainingTimeSeconds: 26900,
	},
	...
	// --------------------------------------------------------------- VIKINGS
	{
		...
		capacity: 70,
		populationCost: 1,
		cost: { wood: 105, clay: 85, iron: 65, crop: 35 },
		trainingTimeSeconds: 960,
	},
	{
		id: 'viking_scout',
		tribe: 'vikings',
		...
		capacity: 0,
		populationCost: 1,
		cost: { wood: 155, clay: 110, iron: 45, crop: 45 },
		trainingTimeSeconds: 1120,
	},
	{
		id: 'axeman_viking',
		...
		capacity: 55,
		populationCost: 1,
		cost: { wood: 145, clay: 135, iron: 185, crop: 70 },
	...
	},
	{
		...
		capacity: 60,
		populationCost: 2,
		cost: { wood: 190, clay: 220, iron: 340, crop: 90 },
		trainingTimeSeconds: 1960,
	},
	{
		id: 'viking_rider',
		tribe: 'vikings',
		...
		capacity: 90,
		populationCost: 2,
		cost: { wood: 415, clay: 380, iron: 305, crop: 85 },
		trainingTimeSeconds: 2640,
	},
	{
		id: 'huscarl',
		...
		capacity: 75,
		populationCost: 3,
		cost: { wood: 590, clay: 640, iron: 715, crop: 160 },
	...
	},
	{
		...
		capacity: 0,
		populationCost: 3,
		cost: { wood: 1010, clay: 415, iron: 440, crop: 75 },
		trainingTimeSeconds: 4700,
	},
	{
		id: 'viking_catapult',
		tribe: 'vikings',
		...
		capacity: 0,
		populationCost: 6,
		cost: { wood: 930, clay: 1350, iron: 640, crop: 80 },
		trainingTimeSeconds: 9000,
	},
	{
		id: 'jarl',
		...
		capacity: 0,
		populationCost: 4,
		cost: { wood: 35800, clay: 29200, iron: 28600, crop: 31500 },
		trainingTimeSeconds: 90700,
	},
	{
		id: 'viking_settler',
		...
		capacity: 3000,
		populationCost: 1,
		cost: { wood: 5900, clay: 5200, iron: 5700, crop: 5800 },
		trainingTimeSeconds: 27500,
	},
];
