...
const troopsByTribe: Record<Tribe, TroopDefinition[]> = {
	...
	egyptians: [
		...
		},
		{
			...
			trainingStatus: 'training',
			queueSize: 1,
			remainingTrainingSeconds: 720,
			currentBatchQuantity: 20,
		},
		{
			id: 'egy-3',
			tribe: 'egyptians',
		...
		},
		{
			...
			remainingTrainingSeconds: 0,
			currentBatchQuantity: 0,
			requirements: ['Academy level 11', 'Blacksmith level 6'],
			requiredBuildings: ['Workshop'],
			estimatedResearchSeconds: 11400,
		},
	],
	huns: [
		{
		...
		},
		{
			...
			trainingStatus: 'training',
			queueSize: 2,
			remainingTrainingSeconds: 1900,
			currentBatchQuantity: 25,
		},
		{
			id: 'hun-4',
			tribe: 'huns',
		...
		},
		{
			...
			requirements: ['Academy level 10', 'Blacksmith level 5'],
			requiredBuildings: ['Workshop'],
			estimatedResearchSeconds: 10200,
		},
	],
};
